...
unit FC.Trade.BrokerConnection.Base;
{$I Compiler.inc}

interface
  uses SysUtils,Classes,Windows,BaseUtils,Properties.Obj,Properties.Definitions,
...
procedure TStockBrokerPropertyEventHandler.OnPropertyCreated(
  aNotifier: TProperty);
begin
