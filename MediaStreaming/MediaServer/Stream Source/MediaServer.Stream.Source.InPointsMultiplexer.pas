...
begin
  ...
  begin
    aSink:=TMediaStreamDataSink.Create(self,FInPoints[i],i);
    FInPoints[i].DataSinks.AddSink(aSink);
  end;
...
procedure TMediaServerSourceInPointsMultiplexer.DoOpen(aSync: boolean);
var
  I: Integer;
begin
  if Opened then
